...
export class Modulo2Aula4Component {
  ...
  areas = [
    ...
    { alt: "b", title: "Logradouro (nome, número):<br>Revisar se o endereço onde está<br> a EDL, está correto, se não, atualizar<br> na coluna de observações.", coords: '193,156,25' },
    ...
    { alt: "i", title: "Estado da EDL: Marcar com base<br> nos critérios de qualidade da<br> instalação e manutenção das<br> EDL's descritas na secção 4.3<br> se o estado da EDL se encontra<br> adequado, ou não.", coords: "1077,93,26"},
    ...
    { alt: "5", title: "Estação Disseminadora não<br> instalada: No momento da<br> visitapara a manutenção<br>  da EDL, o residente informou<br> que a EDL nunca foi instalada,<br> o qual pode acontecer por<br>erros no preenchimento ou<br>digitação do endereço.", coords: "493,783,27"},
    ...
    { alt: "7", title: "Estação Disseminadora quebrada:<br>EDL danificada que impeça seu<br> bom funcionamento.", coords: "843,784,25"},
