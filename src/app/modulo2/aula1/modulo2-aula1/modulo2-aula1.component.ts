...
export class Modulo2Aula1Component {
  ...
  areas = [
    ...
    { alt: "2", title: "Latitude e Longitude: Colocar <br>a coordenada geográfica em <br>graus decimais utilizando GPS,<br>aplicativo de georreferenciamento<br>ou base cadastral do imóvel<br>disponibilizado pelo município.", coords: '187,80,13' },
